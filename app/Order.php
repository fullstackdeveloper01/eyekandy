...
class Order extends Model
{
    ...
    // protected $fillable = ['fee','fee_value','static_fee','order_json','item_name','item_image','address_id','client_id','created_at','updated_at','restorant_id','delivery_price','order_price','payment_method','payment_status','comment','order_ref','total_price','item_json','order_id','order_status'];
