...
class ShiftController extends Controller
{
    ...
    public function index()
    {
        if(auth()->user()->hasRole('admin')){
            return view('shift.index', ['shifts' =>Shift::where(['active'=>1])->paginate(10)]);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        $shift->from_time = strip_tags($request->from_time);
        $shift->to_time = strip_tags($request->to_time);
