    ...
    <div id="liveorders" class="row">
        ...
        <div class="col-xl-3">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('Restaurants Accepted')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
        ...
        <div class="col-xl-3">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <!-- Title -->
              <h5 class="h3 mb-0">{{ __('Delivery Boys Accepted')}}</h5>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <!-- List group -->
        ...
        <div class="col-xl-3">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('Delivery Boys Completed')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
        ...
        <div class="col-xl-3">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <!-- Title -->
                <h5 class="h3 mb-0">{{ __('Delivery Boys Rejects')}}</h5>
              </div>
              <!-- Card body -->
              <div class="card-body">
                <!-- List group -->
