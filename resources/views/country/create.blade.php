                            ...
                            <form method="post" action="{{ route('country.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('country_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="country_name" id="country_name" class="form-control form-control-alternative{{ $errors->has('country_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Country Name') }}" value="" required>
