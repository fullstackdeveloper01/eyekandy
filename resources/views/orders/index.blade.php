                        ...
                        <table class="table align-items-center">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="table-web" scope="col">{{ __('Order Status') }}</th>
                                    <th class="table-web" scope="col">{{ __('Payment Method') }}</th>
                                    ...
                                    @endhasrole
                                    <th class="table-web" scope="col">{{ __('Total Item') }}</th>
                                    <th class="table-web" scope="col">{{ __('Total Price') }}</th>
                                    <th class="table-web" scope="col">{{ __('Delivery Price') }}</th>
                            ...
                            <tr>
                                ...
                                <th scope="row" style="white-space: nowrap;">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="mb-0 text-sm">{{ @$order->restorant->name }}</span><br>
                                ...
                                <td class="table-web">
                                    <?php //date('d M Y H:i:s A',$order->created_at);?>
                                ...
                                @hasrole('admin|owner|driver')
                                <td class="table-web" style="white-space: nowrap;">
                                ...
                                <!-- <td class="table-web">
                                    @money( $order->total_price, env('CASHIER_CURRENCY','INR'),true)

                                </td> -->

                                <td class="table-web">
                                    <?php $data=json_decode($order->order_json); $shipping = $data->shipping_total;?>
                                    @money( $shipping, env('CASHIER_CURRENCY','INR'),true)
                                </td>
