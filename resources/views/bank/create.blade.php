...
@section('content')
    @include('bank.partials.header', ['title' => __('Add Bank')])
                            ...
                            <form method="post" action="{{ route('bank.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('bank_name') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="bank_name" id="bank_name" class="form-control form-control-alternative{{ $errors->has('bank_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Bank Name') }}" value="" required>
