                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">{{ __('Entertainer') }}</th>
                            ...
                            <tbody>
                                @foreach ($packages as $key => $package)
                                    <tr>
                                        ...
                                        <td><span class="editable">{!! $package->package_description !!}</span></td>
                                        <td><span class="editable">{{ $package->package_entertainer }}</span></td>
                                        <td>{{ $package->package_price }}</td>
                                        <td>{{ $package->package_hours }}</td>
                                        <td>{{ $package->package_color }}</td>
                                        <td>@if($package->active=='1')
                                            {{ "Active" }}
                                            @else
                                            {{ "Inactive" }}
                                            @endif
