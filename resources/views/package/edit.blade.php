                                ...
                                <div class="pl-lg-4">
                                    <div class="row">
                                        ...
                                        <div class=" col-md-6 form-group{{ $errors->has('[package_entertainer') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="package_entertainer" id="package_entertainer" class="form-control number form-control-alternative{{ $errors->has('package_entertainer') ? ' is-invalid' : '' }}" placeholder="{{ __('Package Title') }}" value="{{$package->package_entertainer}}" required>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('[package_price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="package_price" id="package_price" class="form-control form-control-alternative{{ $errors->has('package_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Package Price') }}" value="{{$package->package_price}}" required>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('[extra_hour_price') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="extra_hour_price" id="extra_hour_price" class="form-control number form-control-alternative{{ $errors->has('extra_hour_price') ? ' is-invalid' : '' }}" placeholder="{{ __('Hour Price') }}" value="{{$package->extra_hour_price}}" required>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('[package_hours') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="package_hours" id="package_hours" class="form-control number form-control-alternative{{ $errors->has('package_hours') ? ' is-invalid' : '' }}" placeholder="{{ __('Listing Limit') }}" value="{{$package->package_hours}}" required>
                                        ...
                                        <div class="col-md-6 form-group{{ $errors->has('[package_color') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="color" name="package_color" id="package_color" class="form-control form-control-alternative{{ $errors->has('package_color') ? ' is-invalid' : '' }}" placeholder="{{ __('Listing Limit') }}" value="{{$package->package_color}}" required>
