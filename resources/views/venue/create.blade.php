...
@section('content')
    @include('venue.partials.header', ['title' => __('Add Venue')])
                            ...
                            <form method="post" action="{{ route('venue.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="type" id="type" class="form-control form-control-alternative{{ $errors->has('type') ? ' is-invalid' : '' }}" placeholder="{{ __('Enter Venue Type') }}" value="" required>
                                        @if ($errors->has('type'))
