...
@section('content')
    @include('event.partials.header', ['title' => __('Edit Event')])
                                    ...
                                    <div class="row">
                                        <div class="col-6">   
                                            <div class="form-group{{ $errors->has('featured_image') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="file" name="featured_image" id="featured_image" class="form-control form-control-alternative{{ $errors->has('featured_image') ? ' is-invalid' : '' }}"  >
                                                ...
                                                @endif
                                                <img width="100px" height="100px" src="{{ asset("uploads/event/$event->featured_image") }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">   
                                            <div class="form-group{{ $errors->has('event_title') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="text" name="event_title" id="event_title" class="form-control form-control-alternative{{ $errors->has('event_title') ? ' is-invalid' : '' }}" placeholder="{{ __('Title') }}" value="{{$event->event_title}}" required>
                                        ...
                                        <div class="col-12">   
                                            <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                                ...
                                                <textarea name="description" id="description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" rows="5" required="">{{$event->description}}</textarea>
